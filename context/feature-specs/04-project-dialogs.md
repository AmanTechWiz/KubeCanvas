...
Reuse the existing editor layout which is implemented till now. Do not modify the navbar or sidebar behavior.

In the center of the page, add:

- heading: `Create a project or open an existing one?`
- description: `Start a new architecture workspace, or choose any current running project of yours.`
