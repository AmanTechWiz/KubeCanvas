Implement more refinements to the chat agent ui.

## Formatting

Make sure to remove ( ** , #) and make the text be better formatted and presentable in the ui.

make sure to check for both normal and bold fonts.

## SVG SPINNER

copy the thinking animations and style from architect tab.

Add realtime thinking process for chats , refer docs here :
