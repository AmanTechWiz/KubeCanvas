  ...
  return (
    <header
      className={cn('sticky top-0 z-50 w-full border-b border-transparent', {
        // Apple-style liquid glass when scrolled: subtle white translucency, strong blur, soft border
        'bg-[rgba(255,255,255,0.06)] supports-[backdrop-filter]:bg-[rgba(255,255,255,0.04)] border-[rgba(255,255,255,0.08)] backdrop-blur-lg backdrop-saturate-150 shadow-sm':
          scrolled,
      })}
    >
...
function MobileMenu({ open, children, className, ...props }: MobileMenuProps) {
  ...
  return createPortal(
    <div
      id="mobile-menu"
      className={cn(
        // glassy backdrop for full-screen mobile menu
        'bg-[rgba(255,255,255,0.06)] supports-[backdrop-filter]:bg-[rgba(255,255,255,0.04)] backdrop-blur-md',
